    ...
    <SafeAreaView className="flex-1 bg-zinc-50 dark:bg-black" edges={['top']}>
      ...
      <View className="flex-1 px-0">
        {searchQuery.isLoading ? (
          ...
          <View className="flex-1 items-center justify-center px-10 opacity-60">
            <View className="bg-zinc-100 dark:bg-zinc-900 p-6 rounded-full mb-6">
              <TrendingUp size={48} color="#d4d4d8" strokeWidth={1.5} />
            </View>
            <Text className="text-zinc-900 dark:text-white font-bold text-xl text-center mb-2">
              Gündemi Yakala
            </Text>
            <Text className="text-zinc-500 text-center leading-relaxed text-base">
              İlgi duyduğun kategorileri seç veya merak ettiğin konuları ara.
            </Text>
          </View>
        )}
      </View>
