...
export const MOCK_ARTICLE: Article = {
    ...
    summary: 'Maliye Bakanlığı yeni ekonomi paketini açıkladı. Paket kamu harcamalarında kısıtlama ve vergi düzenlemeleri içeriyor.',
    detailContent: 'Maliye Bakanlığı tarafından dün açıklanan kapsamlı ekonomi paketi, kamu harcamalarında kısıtlama ve vergi düzenlemeleri içeriyor. Uzmanlar paketin etkilerini tartışırken, piyasalar ilk tepki olarak olumlu sinyaller verdi. Muhalefet ise paketin dar gelirliyi zorlayacağı görüşünde. Paketin detaylarına göre, kurumlar vergisinde indirim planlanırken, KDV oranlarında da yeniden yapılandırma gündemde. Ekonomistler, bu adımların enflasyonu tek haneye indirmede etkili olabileceğini ancak büyüme oranını olumsuz etkileyebileceğini belirtiyor. Uluslararası kredi derecelendirme kuruluşları ise Türkiye\'nin not görünümünü pozitife çevirme sinyalleri veriyor.',
    isClickbait: false,
    isAd: false,
    isFiltered: false,
    sourceCount: 3,
