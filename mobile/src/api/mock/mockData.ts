...
export const getMockFeed = (country: string = 'tr', page: number = 1): FeedResponse => {
    ...
    const articles: Article[] = Array.from({ length: 5 }).map((_, i) => {
        ...
        return {
            ...
            summary: "Bu haberin özeti yapay zeka tarafından oluşturulmuştur. Detaylar ve analizler için okumaya devam edin. Haberin içeriğindeki önemli noktalar şunlardır: Ekonomik gelişmeler, toplumsal etkiler ve gelecek öngörüleri.",
